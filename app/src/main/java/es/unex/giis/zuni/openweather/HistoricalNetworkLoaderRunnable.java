...
public class HistoricalNetworkLoaderRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Historical historical = service.listHistorical(Double.toString(longt),Double.toString(latt),Long.toString(timeS),"55ab2d28aad932680b93bf96e8e44f6e").execute().body();
